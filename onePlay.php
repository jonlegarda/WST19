  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	function egiaztatu(){
		...
		if($("input[type='radio'].radioBtnClass:checked").val()!=undefined){
			...
			document.getElementById("erantzuna").style.color = "red";
			document.getElementById("erantzuna").innerHTML = "Egiaztatzeko erantzuren bat aukeratu behar da!";
		}
	}
...
<div class="container-fluid">
	...
	<?php
		...
		<input type="button" id="ikusi" name="ikusi" value="Galdera Ikusi" onClick="galderakJaso()" style="width: 160px"/>
